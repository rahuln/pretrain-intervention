...
TASK_REGISTRY.update(
    {
        ...
        **mmlu_std.create_all_tasks(),
        ...
        "pararel_patterns_subset_std": pararel_patterns_std.ParaRelPatternsSubsetQAStd,
        "pararel_patterns_std": pararel_patterns_std.ParaRelPatternsQAStd,
        **pararel_patterns_std.create_all_tasks(),
    }
)
