...
from .pararel_patterns_std import create_catwalk_pararel_patterns_std_tasks
...
TASKS_STD: Dict[str, Task] = {
    ...
    **create_catwalk_mmlu_std_tasks(),
    ...
    "pararel_patterns_subset_std": EleutherMMLUTask(
        "pararel_patterns_subset_std", ranked_classification=True
    ).add_metrics(rc_metrics(primary="acc_uncond")),
    "pararel_patterns_std": EleutherMMLUTask(
        "pararel_patterns_std", ranked_classification=True
    ).add_metrics(rc_metrics(primary="acc_uncond")),
    **create_catwalk_pararel_patterns_std_tasks(),
}
